...
public class KebabTest {
    ...
    public void setUp() {
        ...
        superKebab = new Salade("laitue",
				new Tomate("tomate rouge",
						new Boeuf ("boeuf 100% francais",
								new Fromage("cheddar",
										new Sauce("sauce algérienne",
											new Oignon("oignon blanc",
													new Pain("pita",
    ...
    public void un_kebab_contient_bien_les_noms_de_tous_les_ingredients_ajoutes() {
		...
		.containsExactly("pita","oignon blanc","sauce algérienne","cheddar","petite crevette","tomate rouge","laitue");
     	...
     	assertThat(superKebab.getIngredients()).extracting("nom")
		.containsExactly("pita","oignon blanc","sauce algérienne","cheddar","boeuf 100% francais","tomate rouge","laitue");
    ...
    @Test
    public void superKebab_isnt_vegetarien() {
    	assertThat(superKebab.isPescetarien()).isFalse();
    }
    @Test
    public void superKebab_isnt_pescetarein() {
    	assertThat(superKebab.isPescetarien()).isFalse();
    }
